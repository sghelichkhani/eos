...
module EoS.DebyeModel.Test.Phases
open System
...
let mgwa = phases.TryGetObject<IPhase>("mgwa").Value
let mgri = phases.TryGetObject<IPhase>("mgri").Value

let co = phases.TryGetObject<IPhase>("co").Value
